...
def run_qc_summary(run):
    ...
    logger.info(f"Accessing run forlder data at path : {run}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="inter_op.py",
        description="Extracts run-lev QC from Illumina InterOp directory."
        )
    parser.add_argument("-r", "--run", type=str, help="sequencing run folder")
